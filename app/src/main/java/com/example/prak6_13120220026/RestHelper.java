package com.example.prak6_13120220026;
...
public class RestHelper {
    ...
    private final String URL = "http://172.125.1.27/praktikum6a/";
    ...
    public void getDataMhs (final RestCallbackMahasiswa callbackMahasiswa) { arrListMhs.clear();
        ...
        errorListener = new Response. ErrorListener() {
            @Override
            public void onErrorResponse (VolleyError error) { tampilPesan (context, error.toString());
            }
        };
    ...
    public void editData (String stb, Mahasiswa mhs) {
        ...
        System.out.println("data json:" + jsonObject.toString()); jsonObjectListener = new Response. Listener<JSONObject>() {
            @Override
            public void onResponse (JSONObject response) {
                try {
                    if (response.getInt("hasil") == 1) {
